...
class UserManager(auth_models.BaseUserManager):
    ...
    def create_barber(self, email: str, name: str, password: str, surname: str) -> 'User':
        return self._create_user(account_type=value_objects.AccountType.BARBER, email=email, name=name, password=password, surname=surname)
...
class User(auth_models.AbstractBaseUser):
    ...
    def delete(self) -> None:
        ...
        if self.account_status not in (value_objects.AccountStatus.CLOSED.name, value_objects.AccountStatus.DELETED.name):
